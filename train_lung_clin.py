...
if __name__ == '__main__':
    ...
    train_df = pd.read_csv('./output2/lung_best_fold_train.csv')
    val_df = pd.read_csv('./output2/lung_best_fold_val.csv')
    ...
    # 保存为 CSV
    combined_df_sorted.to_csv('./output2/lung_clin_train_val_probs.csv', index=False)
